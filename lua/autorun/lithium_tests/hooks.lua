...
-- Post-Hook with return modifying overall return value (NOT APPLICABLE)
-- TEST(function(name)
...
-- Post-Hook without return not modifying overall return value (NOT APPLICABLE)
-- TEST(function(name)
-- 	local return_value = nil
-- 	Add(name, "normalhook", function() return "original_return" end, NORMAL_HOOK)
...
-- Post-Hok running after gamemode function (NOT APPLICABLE)
-- TEST(function(name)
-- 	local gm_table = {}
-- 	gm_table[name] = function() return "gm_called" end
...
-- Post-Hook modifying gamemode function return value (NOT APPLICABLE)
-- TEST(function(name)
-- 	local gm_table = {}
-- 	gm_table[name] = function() return "gm_called" end
-- 	Add(name, "postHookreturn", function() return "post_modified" end, POST_HOOK_RETURN)
...
-- Test calling with no return values in normal hook, gm should run (NOT APPLICABLE)
-- TEST(function(name)
...
-- Test calling with return values in normal hook, gm should not run (NOT APPLICABLE)
-- TEST(function(name)
-- 	local gm_called, normal_called, post_called
...
-- Test calling with no return values in normal hook, and gm returns values (NOT APPLICABLE)
-- TEST(function(name)
-- 	local gm_called, normal_called, post_called
...
-- Test calling with post hook modifies normal hook return, gm shouldnt run (NOT APPLICABLE)
-- TEST(function(name)
-- 	local gm_called, normal_called, post_called
...
-- Test calling with post hook modifies gm function return (NOT APPLICABLE)
-- TEST(function(name)
-- 	local gm_called, normal_called, post_called
...
local test_name = "lihtium_hook_test"
function Test()
